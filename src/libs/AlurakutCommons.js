    ...
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        ...
        <button type="button" onClick={() => setMenuState(!isMenuOpen)}>
          {isMenuOpen && <img alt="icon" src={`${BASE_URL}/icons/menu-open.svg?v=${v}`} />}
          {!isMenuOpen && <img alt="icon" src={`${BASE_URL}/icons/menu-closed.svg?v=${v}`} />}
        </button>
      </div>
...
function AlurakutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="alurakutMenuProfileSidebar">
      <div>
        <img alt="icon" src={`https://github.com/${githubUser}.png`} style={{ borderRadius: '8px' }} />
        <hr />
        <p>
...
export function AlurakutProfileSidebarMenuDefault() {
  return (
    <AlurakutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
          <img alt="icon" src={`${BASE_URL}/icons/user.svg`} />
          Perfil
        </a>
        <a href="/">
          <img alt="icon" src={`${BASE_URL}/icons/book.svg`} />
          Recados
        </a>
        <a href="/">
          <img alt="icon" src={`${BASE_URL}/icons/camera.svg`} />
          Fotos
        </a>
        <a href="/">
          <img alt="icon" src={`${BASE_URL}/icons/sun.svg`} />
          Depoimentos
        </a>
      </nav>
      <hr />
      <nav>
        <a href="/">
          <img alt="icon" src={`${BASE_URL}/icons/plus.svg`} />
          GitHub Trends
        </a>
        <a href="/logout">
          <img alt="icon" src={`${BASE_URL}//icons/logout.svg`} />
          Sair
        </a>
      </nav>
    </AlurakutProfileSidebarMenuDefault.Wrapper>
      ...
      {[
        ...
        <li key={`orkut__icon_set__${slug}`}>
          ...
          <span className="OrkutNostalgicIconSet__number" style={{ gridArea: 'number' }}>
            <img alt="icon" key={`orkut__icon_set__${slug}_img`} className="OrkutNostalgicIconSet__iconSample" src={`https://alurakut.vercel.app/icons/${icon}.svg`} />
          ...
          <li key={`orkut__icon_set__${slug}`}>
            ...
            <span className="OrkutNostalgicIconSet__iconComplex" className="OrkutNostalgicIconSet__number" style={{ gridArea: 'number' }}>
              {[0, 1, 2].map((_, index) => {
                ...
                return <img alt="icon" key={`orkut__icon_set__${slug}_img_${index}`} src={`https://alurakut.vercel.app/icons/${icon}.svg`} style={{ marginRight: '2px', opacity: isHeartActive ? 1 : '0.5' }} />;
              })}
            </span>
          </li>
        );
